        ...
        <Row>
          <Col md={8} className='home-about-description'>
            ...
            <p className='home-about-body'>
              Professional with 4+ years of experience in India & Germany.
              <br />
              ...
              <i>
                ...
                <b className='purple'>Product Management.</b>
              </i>
              <br />
              <br />
              ...
              <i>
                <b className='purple'> Modern Python Library and Frameworks</b>
              </i>
              &nbsp; like
              <i>
